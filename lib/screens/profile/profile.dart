  ...
  return Scaffold(
    ...
    body: CustomScrollView(
      slivers: [
            ...
            child: SafeArea(
              ...
              child: Column(
                children: [
                  ...
                  // Foto + nama + email di dalam header
        ...
        // Hapus SliverToBoxAdapter height 74 dan nama/email yang lama
        ...
        SliverToBoxAdapter(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                const Text('Akun', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.textLight, letterSpacing: 0.8)),
                ...
                _buildMenuCard(context, [
                  _MenuItem(
                    ...
                    onTap: (ctx) {
                      Navigator.push(context, MaterialPageRoute(builder: (_) => const EditProfilPage()))
                          .then((updated) {
                        if (!context.mounted) return;
                        if (updated == true) {
                          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => ProfileScreen(showBackButton: showBackButton)));
                        }
                      });
                    },
                  ),
                  _MenuItem(
                    ...
                    bgColor: AppColors.categoryBg1,
                    iconColor: AppColors.primary,
                    onTap: (ctx) => Navigator.push(ctx, MaterialPageRoute(builder: (_) => const MedicalReportPage())),
                  ),
                  _MenuItem(
                    ...
                    bgColor: AppColors.categoryBg1,
                    iconColor: AppColors.primary,
                    onTap: (ctx) => Navigator.push(ctx, MaterialPageRoute(builder: (_) => const ShopReportPage())),
                  ),
                  _MenuItem(
                    ...
                    onTap: (ctx) => Navigator.push(ctx, MaterialPageRoute(builder: (_) => const UbahPasswordPage())),
                  ),
                ]),
                const SizedBox(height: 20),
                const Text('Lainnya', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.textLight, letterSpacing: 0.8)),
                const SizedBox(height: 10),
                _buildMenuCard(context, [
                  _MenuItem(
                    ...
                    onTap: (ctx) => Navigator.push(ctx, MaterialPageRoute(builder: (_) => const BantuanFaqPage())),
                  ),
                  _MenuItem(
                    ...
                    bgColor: AppColors.categoryBg1,
                    iconColor: AppColors.primary,
                    onTap: (ctx) => Navigator.push(ctx, MaterialPageRoute(builder: (_) => const KebijakanPrivasiPage())),
                  ),
                  _MenuItem(
                    ...
                    onTap: (ctx) => Navigator.push(ctx, MaterialPageRoute(builder: (_) => const TentangAplikasiPage())),
                  ),
                ]),
                const SizedBox(height: 20),
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: const Text('Keluar dari Akun', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15)),
                  ),
                ),
